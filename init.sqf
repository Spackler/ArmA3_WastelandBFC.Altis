...
if (!isDedicated) then
{
	[] spawn
	{
		...
		{
			9999 cutText ["Welcome to Bravo Foxtrot Company, please wait for your client to initialize", "BLACK", 0.01];
...
if (isServer) then
{
	...
	diag_log "Bravo Foxtrot Company SERVER - Initializing Server";
