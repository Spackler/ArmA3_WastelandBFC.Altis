...
class TOParmaInfoD
{
	...
	{	
		...
		{
			idc = 10032;
			text = "BravoFoxtrotCompany.com Information";
		...
		class TAGeneralInfoBackground: RscText
		{
			...
			type = CT_STRUCTURED_TEXT;
			size = 0.030;
			text = "Website: BravoFoxtrotCompany.com Forums: forums.BravoFoxtrotCompany.com TeamSpeak: Coming Soon";
			x = "0 * (((safezoneW / safezoneH) min 1.2) / 40)";
