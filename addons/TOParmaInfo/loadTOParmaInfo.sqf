...
_serverInfoString = format ["<t color='#A0FFFFFF'>BFC Wasteland %2</t>", call A3W_extDB_ServerID, worldName];
...
_generalInfoString = "Website: <t color='#0091CD'><a href='http://bravofoxtrotcompany.com'>BravoFoxtrotCompany.com</a></t> Forums: <t color='#0091CD'><a href='http://forums.bravofoxtrotcompany.com'>forums.BravoFoxtrotCompay.com</a></t> TeamSpeak: Coming Soon";
_generalInfoText ctrlSetStructuredText parseText _generalInfoString;


_rulesOnline = "http://bravofoxtrotcompany.com/r/" + _uid + "/r.html";
_rulesOffline = "addons\TOParmaInfo\rules.html";
_newsOnline = "http://bravofoxtrotcompany.com/n/" + _uid + "/n.html";
_newsOffline = "addons\TOParmaInfo\news.html";
_statsOnline = "http://bravofoxtrotcompany.com/s/" + _uid + "/s.html";
