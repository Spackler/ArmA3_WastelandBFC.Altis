...
switch (_boxType) do
{
	...
	case "mission_USSpecial":
	{
		...
		[
			...
			["itm", ["optic_MRCO", "optic_Arco", "optic_Hamr", "optic_SOS","optic_Nightstalker","optic_tws"], RANDOM_BETWEEN(0,2)],
	...
	case "mission_Main_A3snipers":
	{
		...
		[
			...
			["bac", ["B_Carryall_mcamo", "B_Kitbag_mcamo"], RANDOM_BETWEEN(2,5)],
			["itm", "ItemGPS", RANDOM_BETWEEN(0,1)],
			["itm", "optic_DMS","optic_Nightstalker","optic_tws", RANDOM_BETWEEN(1,2)]
		];
	};
